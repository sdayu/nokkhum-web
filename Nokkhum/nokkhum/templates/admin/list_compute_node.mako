...
<section>
	...
	% for compute_node in compute_nodes:
		<li>
			<strong>Compute Node id: <span style="color: red;">${compute_node.id}</span></strong>
			<ul>
				...
				<li><strong>machine: </strong> ${compute_node.matchine}</li>
				...
				% if (datetime.datetime.now() - compute_node.update_date).minutes < 1:
