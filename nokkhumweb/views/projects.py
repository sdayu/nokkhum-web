...
@view_config(route_name='projects.index', permission='authenticated', renderer='/projects/index.jinja2')
def index(request):
...
@view_config(route_name='projects.add', permission='authenticated', renderer='/projects/add.jinja2')
def add(request):
...
@view_config(route_name='projects.view', permission='authenticated', renderer='/projects/view.jinja2')
def view(request):
    project_id = request.matchdict['project_id']
    project = request.nokkhum_client.projects.get(project_id)
    return dict(project=project)

@view_config(route_name='projects.edit', permission='authenticated', renderer='/projects/add.jinja2')
def edit(request):
